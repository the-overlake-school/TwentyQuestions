...
public class VaderMain implements ActionListener, KeyListener, Runnable, UserInterface {
    ...
    private static final String RESOURCE_URL = "http://www.cs.washington.edu/education/courses/cse143/14sp/homework/7/";
    private static final String SAVE_DEFAULT_FILE_NAME = "memory.txt";
    private static final String MUSIC_FILE_NAME = "multimedia/empire%d.mid";
    private static String BACKGROUND_IMAGE_FILE_NAME = "multimedia/background.png";
    private static String SOUND_FILE_NAME = "multimedia/vader%d.wav";
    ...
    public VaderMain() {
        if (ITS_A_TRAP) {
            ...
            TITLE = "It's a Trap!!!";
            BACKGROUND_IMAGE_FILE_NAME = "multimedia/ackbar.png";
            SOUND_FILE_NAME = "multimedia/ackbar%d.wav";
            NUM_SOUNDS = 4;
        }
